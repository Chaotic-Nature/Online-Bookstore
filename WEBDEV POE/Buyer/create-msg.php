...
<html lang="en">
  ...
  <body>
    <div id="header-background-create"></div>
          ...
          <i class ="fa fa-bars" onclick="showMenu()"></i>
              ...
              <div class="container" id="center">
                ...
                <div class="content">
                  ...
                  <form action="../form_processing/?php echo $id; ?>" method="POST" enctype="multipart/form-data">
                    <div class="user-details">
                      <div class="form-group">
                        <span class="details">Select a book</span>
                      ...
                      <div class="bookcon">
                      <input type="radio" name="availableCheck" id="dot-1" value="Bad">

                      <span class="book-title">Choose a Book enquiry</span>
                      <div class="category">
                        <label for="dot-1">
                          <span class="dot one"></span>
                          <span class="condition">Is the book still available?</span>
                        </label>
                      </div>
                      </div>
                      <div class="form-group">
                        <span class="details">Enter Your own Message</span>
