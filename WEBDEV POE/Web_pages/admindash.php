                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="../Admin/books.php"> Books</a></a>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    if($total_orders = mysqli_num_rows($result)){
                                        while (($Row = mysqli_fetch_assoc($result)) !== null)
                                        {
                                            ...
                                            echo '<td><a><img src="../images/edit.png" alt="Edit image" width="25" height="25"/></a><td>';
                                ...
                                <?php 
                                    ...
                                    if($total_orders = mysqli_num_rows($result)){
                                        while (($Row = mysqli_fetch_assoc($result)) !== null)
                                        {
                                            ...
                                            echo '<td><Center><a href="../Admin/edit_book.php?id" class="btn">Edit</a><Center><td>';
                                            echo '<td><Center><a><img src="../images/trash.gif"
                                            alt="Delete image" width="50" height="50"/></a><Center><td>';
                                        }
                                    }
                                    else{
                                        echo '<h1> No Orders</h1>';
                        ...
                        <div class="recent-payments">
                            ...
                            <table> 
                                ...
                                <tr>
                                    ...
                                    <td><Center><a><img src="../images/trash.gif"
                                            alt="Delete image" width="50" height="50"/></a><Center><td>
                                </tr>
                                <tr>
                                    <td>Liam</td>
